...
#	define DEF_HAS_MAKE_UNIQUE			1
#else
#	define DEF_HAS_VARIADIC_TEMPLATES	0
#	define DEF_HAS_MAKE_UNIQUE			0
#endif
...
typedef enum GL2D_GL_ACCESS : unsigned int
{
	GL2D_GL_ACCESS_READ_ONLY	= 0x88B8,
	GL2D_GL_ACCESS_WRITE_ONLY	= 0x88B9,
	GL2D_GL_ACCESS_READ_WRITE	= 0x88BA,
}	GL2D_GL_ACCESS;
...
: unsigned int
{
	GL2D_GL_INTERNAL_1							= 0x0001,
	GL2D_GL_INTERNAL_2							= 0x0002,
	GL2D_GL_INTERNAL_3							= 0x0003,
	GL2D_GL_INTERNAL_4							= 0x0004,
...
typedef enum GL2D_GL_DEBUG_TYPE
: uint32_t
{
	GL2D_GL_DEBUG_TYPE_ERROR				= 0x824C,
	GL2D_GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR	= 0x824D,
	GL2D_GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR	= 0x824E,
	GL2D_GL_DEBUG_TYPE_PORTABILITY			= 0x824F,
	GL2D_GL_DEBUG_TYPE_PERFORMANCE			= 0x8250,
	GL2D_GL_DEBUG_TYPE_OTHER				= 0x8251,
}	GL2D_GL_DEBUG_TYPE;

typedef enum GL2D_GL_DEBUG_SOURCE
: uint32_t
{
	GL2D_GL_DEBUG_SOURCE_API				= 0x8246,
	GL2D_GL_DEBUG_SOURCE_WINDOW_SYSTEM		= 0x8247,
	GL2D_GL_DEBUG_SOURCE_SHADER_COMPILER	= 0x8248,
	GL2D_GL_DEBUG_SOURCE_THIRD_PARTY		= 0x8249,
	GL2D_GL_DEBUG_SOURCE_APPLICATION		= 0x824A,
	GL2D_GL_DEBUG_SOURCE_OTHER				= 0x824B,
}	GL2D_GL_DEBUG_SOURCE;

typedef enum GL2D_GL_DEBUG_CATEGORY
: uint32_t
{
	GL2D_GL_DEBUG_CATEGORY_API_ERROR			= 0x9149,
	GL2D_GL_DEBUG_CATEGORY_WINDOW_SYSTEM		= 0x914A,
	GL2D_GL_DEBUG_CATEGORY_DEPRECATION			= 0x914B,
	GL2D_GL_DEBUG_CATEGORY_UNDEFINED_BEHAVIOR	= 0x914C,
	GL2D_GL_DEBUG_CATEGORY_PERFORMANCE			= 0x914D,
	GL2D_GL_DEBUG_CATEGORY_SHADER_COMPILER		= 0x914E,
	GL2D_GL_DEBUG_CATEGORY_APPLICATION			= 0x914F,
	GL2D_GL_DEBUG_CATEGORY_OTHER				= 0x9150,
}	GL2D_GL_DEBUG_CATEGORY;

typedef enum GL2D_GL_DEBUG_SEVERITY
: uint32_t
{
	GL2D_GL_DEBUG_SEVERITY_HIGH		= 0x9146,
	GL2D_GL_DEBUG_SEVERITY_MEDIUM	= 0x9147,
	GL2D_GL_DEBUG_SEVERITY_LOW		= 0x9148,
}	GL2D_GL_DEBUG_SEVERITY;

typedef enum GL2D_GL_CREATECONTEXT_ATTRIB
{
	GL2D_GL_CREATECONTEXT_ATTRIB_DEBUG_BIT				= 0x0001,
	GL2D_GL_CREATECONTEXT_ATTRIB_FORWARD_COMPATIBLE_BIT	= 0x0002,
	GL2D_GL_CREATECONTEXT_ATTRIB_MAJOR_VERSION			= 0x2091,
	GL2D_GL_CREATECONTEXT_ATTRIB_MINOR_VERSION			= 0x2092,
	GL2D_GL_CREATECONTEXT_ATTRIB_LAYER_PLANE			= 0x2093,
	GL2D_GL_CREATECONTEXT_ATTRIB_FLAGS					= 0x2094,
}	GL2D_GL_CREATECONTEXT_ATTRIB;

typedef enum GL2D_GL_PROFILE_ATTRIB
{
	GL2D_GL_PROFILE_ATTRIB_CORE_BIT				= 0x0001,
	GL2D_GL_PROFILE_ATTRIB_COMPATIBILITY_BIT	= 0x0002,
	GL2D_GL_PROFILE_ATTRIB_MASK					= 0x9126,
}	GL2D_GL_PROFILE_ATTRIB;

static const GLenum GL2D_GL_DEBUG_OUTPUT_SYNCHRONOUS = 0x8242;
#endif
