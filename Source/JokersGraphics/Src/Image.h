...
namespace Joker
{
	...
	public:
		...
		/**@name Accessors */
		//@{
		inline String const & GetFilePath()const { return m_strFilePath; }
		inline long long GetSize()const { return m_llSize; }
		inline unsigned int GetResourceId()const { return m_uiResourceID; }
		//@}
